...
abstract final class DecoyBallGenerator {
  static const _pool2 = [
    'XY', 'QZ', 'VK', 'JT', 'PW', 'HX', 'NB', 'CM', 'YD', 'ZP',
    'WQ', 'KF', 'RV', 'TG', 'LH', 'MX', 'BP', 'SN', 'DW', 'YH',
    'QF', 'XZ', 'JV', 'WK', 'PN', 'RF', 'GL', 'TC', 'BH', 'ZK',
    'VJ', 'TY', 'QM', 'HF', 'LP', 'NG', 'WD', 'XS', 'BR', 'KC',
    'AZ', 'BY', 'CX', 'DV', 'EU', 'FW', 'GT', 'HS', 'IR', 'JO',
    'KP', 'LQ', 'MR', 'NS', 'OT', 'PU', 'QV', 'RW', 'SX', 'TZ',
  ];

  static const _pool3 = [
    'XYQ', 'QZV', 'VKJ', 'JTP', 'PWH', 'HXN', 'NBC', 'CMY', 'YDZ',
    'ZPW', 'WQK', 'KFR', 'RVT', 'TGL', 'LHM', 'MXB', 'BPS', 'SND',
    'DWY', 'YHQ', 'QFX', 'XZJ', 'JVK', 'WKN', 'PNR', 'RFG', 'GLT',
    'TCB', 'BHZ', 'ZKV', 'VJT', 'TYQ', 'QMH', 'HFL', 'LPN', 'NGW',
    'WDX', 'XSB', 'BRK', 'KCV', 'VQM', 'MHT', 'TLZ', 'ZPX', 'XQN',
    'AZK', 'BYL', 'CXM', 'DVN', 'EUO', 'FWP', 'GTQ', 'HSR', 'IRT',
    'JOU', 'KPV', 'LQW', 'MRX', 'NSY', 'OTZ', 'PUA', 'QVB', 'RWC',
  ];

  /// Scales decoys with level size + difficulty so the board feels full.
  static int countForLevel(Level level) {
    final fragments =
        level.words.fold<int>(0, (sum, w) => sum + w.fragments.length);
  ...
  static List<Ball> generate(Level level, Uuid uuid) {
    ...
    final used = <String>{
      for (final w in level.words) ...w.fragments,
    };
    final decoys = <Ball>[];
